import { AudioContext, AudioWorkletNode, OfflineAudioContext, isAnyAudioContext, isAnyOfflineAudioContext, isAnyAudioParam, isAnyAudioNode } from '../../../../../_snowpack/pkg/standardized-audio-context.js';
export { isSupported as supported } from '../../../../../_snowpack/pkg/standardized-audio-context.js';
...
function createAudioWorkletNode(context, name, options) {
    assert(isDefined(AudioWorkletNode), "This node only works in a secure context (https or localhost)");
    // @ts-ignore
